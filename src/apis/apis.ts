...
export const apiHandlers: ApiHandlers = {
  ...
  [auth.registerApiName]: { process: auth.registerUser as unknown as (params: unknown, context: ApiHandlerContext) => Promise<unknown> },
  [auth.loginApiName]: { process: auth.loginUser as unknown as (params: unknown, context: ApiHandlerContext) => Promise<unknown> },
  ...
  [auth.logoutApiName]: { process: auth.logoutUser as unknown as (params: unknown, context: ApiHandlerContext) => Promise<unknown> },
