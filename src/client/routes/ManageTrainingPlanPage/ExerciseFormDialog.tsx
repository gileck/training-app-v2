...
// A very simple generic placeholder for when an image fails to load
const GENERIC_IMAGE_PLACEHOLDER = "/images/exercises/placeholder-generic.png"; // Ensure this path is valid
