...
export const AIChatIcon: React.FC<SvgIconProps> = (props) => {
  return (
    <SvgIcon {...props} viewBox="0 0 48 48">
      ...
      <path 
        d="M 8 4 L 36 4 Q 44 4 44 12 L 44 36 Q 44 44 36 44 L 12 44 Q 4 44 4 36 L 4 12 Q 4 4 12 4 Z" 
        fill="none" 
      ...
      {/* Small sparkle/star (top right corner) */}
