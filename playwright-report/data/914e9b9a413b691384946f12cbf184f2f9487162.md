...
- Name: Training Plans >> should set active training plan
- Location: /Users/gil/Projects/training-app-v2/tests/e2e/training-plans.spec.ts:86:9
...
Locator: locator('[data-testid="plan-card"]').filter({ hasNotText: 'Active' }).first().locator('[data-testid="active-badge"]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('[data-testid="plan-card"]').filter({ hasNotText: 'Active' }).first().locator('[data-testid="active-badge"]')

    at /Users/gil/Projects/training-app-v2/tests/e2e/training-plans.spec.ts:96:76
```
